    ...
    nav: [
      {
        ...
        items: [
          ...
          { id: 'admin-saas-users', label: 'SAAS用户', icon: 'users' },
          { id: 'admin-employees', label: '平台员工', icon: 'id-card' },
          { id: 'admin-roles', label: '角色管理', icon: 'key' },
          { id: 'admin-media', label: '官媒投稿', icon: 'send' },
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'admin-logs', label: '系统日志', icon: 'file-text' },
          { id: 'admin-account', label: '账号设置', icon: 'user-circle' }
        ]
      },
      {
        section: '站群管理',
    ...
    nav: [
      {
        ...
        items: [
          ...
          { id: 'tenant-products', label: '产品管理', icon: 'package' }
        ]
      },
      {
        section: '国内GEO管理',
        items: [
          ...
          { id: 'tenant-knowledge', label: 'GEO知识库', icon: 'book' },
          { id: 'tenant-media', label: '官媒投稿', icon: 'send' }
        ]
      },
      {
        section: '运营管理',
        items: [
          { id: 'tenant-reports', label: '效果报表', icon: 'chart' },
          { id: 'tenant-crawl', label: '采集任务', icon: 'download' },
          { id: 'tenant-cases', label: '案例库', icon: 'award' },
          { id: 'tenant-finance', label: '财务流水', icon: 'banknote' }
        ]
      },
      {
        section: '系统管理',
        items: [
          ...
          { id: 'tenant-messages', label: '系统消息', icon: 'bell' },
          { id: 'tenant-logs', label: '系统日志', icon: 'file-text' },
          { id: 'tenant-account', label: '账号设置', icon: 'user-circle' }
        ]
      },
      {
        section: '站群管理',
    ...
    nav: [
      {
        ...
        items: [
          ...
          { id: 'agent-projects', label: '项目管理', icon: 'folder' },
          { id: 'agent-customers', label: '客户管理', icon: 'users' },
          { id: 'agent-sub-agents', label: '子代理管理', icon: 'network' },
      ...
      },
      {
        section: '运营管理',
        items: [
          { id: 'agent-reports', label: '效果报表', icon: 'chart' },
          { id: 'agent-cases', label: '案例库', icon: 'award' },
          { id: 'agent-finance', label: '财务流水', icon: 'banknote' }
        ]
      },
      {
        section: '系统管理',
        items: [
          ...
          { id: 'agent-announcements', label: '消息公告', icon: 'megaphone' },
          { id: 'agent-messages', label: '系统消息', icon: 'bell' },
          { id: 'agent-logs', label: '操作日志', icon: 'file-text' },
          { id: 'agent-account', label: '账号设置', icon: 'user-circle' }
        ]
      }
    ],
    user: {
    ...
    nav: [
      {
        ...
        items: [
          ...
          { id: 'enduser-projects', label: '我的项目', icon: 'folder' },
          { id: 'enduser-reports', label: '效果报表', icon: 'chart' }
        ]
      },
      {
        section: '企业知识库',
        items: [
          { id: 'enduser-knowledge-intro', label: '企业介绍', icon: 'book' },
          { id: 'enduser-knowledge-album', label: '企业相册', icon: 'image' }
        ]
      },
      {
        section: '账户管理',
        items: [
          { id: 'enduser-finance', label: '财务流水', icon: 'banknote' },
          { id: 'enduser-messages', label: '系统消息', icon: 'bell' },
          { id: 'enduser-account', label: '账号设置', icon: 'user-circle' }
        ]
      }
    ],
    user: {
...
const PAGE_TITLES = {
  // 超级管理员
  'admin-dashboard': '工作台',
  'admin-saas-users': 'SAAS用户',
  'admin-employees': '平台员工',
  'admin-roles': '角色管理',
  'admin-media': '官媒投稿',
  'admin-finance': '财务流水',
  'admin-settings': '系统设置',
  ...
  'tenant-messages': '系统消息',
  'tenant-logs': '系统日志',
  'tenant-account': '账号设置',
  'tenant-report-settings': '报表设置',
  'tenant-collection-settings': '采集设置',
  ...
  'enduser-projects': '我的项目',
  'enduser-reports': '效果报表',
  'enduser-knowledge-intro': '企业介绍',
  'enduser-knowledge-album': '企业相册',
  'enduser-finance': '财务流水',
  'enduser-messages': '系统消息',
  'enduser-account': '账号设置'
};
