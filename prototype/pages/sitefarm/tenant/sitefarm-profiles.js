 ...
 * 租户端 - 基础资料管理
 */
function renderTenantSitefarmProfiles() {
  return `
    <div class="page-header">
      <div class="page-header-left">
        <h1 class="page-header-title">基础资料管理</h1>
        <p class="page-header-desc">维护企业基本信息，用于站群内容生成</p>
      </div>
    </div>
    ...
    <div class="card-grid">
      <div class="card-item" style="grid-column: 1 / -1; padding: 24px;">
        ...
        <div class="form-group">
          ...
          <textarea class="form-textarea" rows="4" placeholder="请输入公司介绍">深圳智达恒业包装制品有限公司成立于2010年，专注于瓦楞纸箱、彩盒、礼品包装等纸制品的研发、生产与销售，服务覆盖珠三角及全国主要城市。</textarea>
        </div>
